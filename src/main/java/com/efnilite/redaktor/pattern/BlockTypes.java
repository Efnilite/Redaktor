...
public enum BlockTypes {
    ...
    STAIRS(Material.ACACIA_STAIRS, Material.ANDESITE_STAIRS, Material.BIRCH_STAIRS, Material.BRICK_STAIRS, Material.COBBLESTONE_STAIRS, Material.DIORITE_STAIRS, Material.GRANITE_STAIRS,
            Material.JUNGLE_STAIRS, Material.OAK_STAIRS, Material.PRISMARINE_STAIRS, Material.PURPUR_STAIRS, Material.QUARTZ_STAIRS, Material.SANDSTONE_STAIRS, Material.SPRUCE_STAIRS,
            Material.STONE_STAIRS, Material.DARK_OAK_STAIRS, Material.DARK_PRISMARINE_STAIRS, Material.MOSSY_COBBLESTONE_STAIRS, Material.NETHER_BRICK_STAIRS, Material.POLISHED_ANDESITE_STAIRS,
            Material.POLISHED_DIORITE_STAIRS, Material.POLISHED_GRANITE_STAIRS, Material.PRISMARINE_BRICK_STAIRS, Material.RED_SANDSTONE_STAIRS, Material.SMOOTH_QUARTZ_STAIRS,
            Material.SMOOTH_SANDSTONE_STAIRS, Material.STONE_BRICK_STAIRS, Material.END_STONE_BRICK_STAIRS, Material.MOSSY_STONE_BRICK_STAIRS, Material.RED_NETHER_BRICK_STAIRS,
